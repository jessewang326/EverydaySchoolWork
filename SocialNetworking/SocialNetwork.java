...
public class SocialNetwork {
	...
	/**
	 * getNumFriends method is a getter method
	 * that gets the number of friend in the friend list
	...
	/**
	 * clearFriends method is a method
	 * that remove all friends from the list
	 */
	...
	public static void main (String[] args) {
		...
		//add in a new person
		network1.add("Ying", "Zhang", "yz@uwo.ca");
		//add in a new person
		network1.add("Nancy", "Du", "nd@uwo.ca");
		//add in a new person
		network1.add("Phoebe","zheng", "pz@uwo.ca");
		
		//testing
		System.out.println(network1.getNumFriends());
		network1.clearFriends();
